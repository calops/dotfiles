    ...
    -- Syntax-aware text objects and motions
    {
        ...
        init = function()
            ...
            nmap {
                ...
                ["<M-Left>"] = { dot_repeatable("v:lua.STSSwapCurrentNodePrevNormal_Dot"), "Swap with previous node", expr = true },
                ["<M-Right>"] = { dot_repeatable("v:lua.STSSwapCurrentNodeNextNormal_Dot"), "Swap with next node", expr = true },
                ["gO"] = {
                    function()
